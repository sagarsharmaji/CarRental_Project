...
try{
	...
	stmt.executeQuery("select * from ser_pro where semail = '"+email+"' and spass = '"+pass+"';");
	
				out.println("<script type=\"text/javascript\">");
				out.println("alert('Now go to Booking');");
				out.println("location='checkbooking.jsp';");
				out.println("</script>");
				String site=new String("http://localhost:8080/test/CRMS/checkbooking.jsp");
